...
As of 2026-06-18, the project is published to `EgorArutiunean/faethon-system` on GitHub. Live production deployment is deferred until server access and legacy data readiness are complete.

Implemented:

- product, product category, partner, and warehouse directories;
- product category creation, editing, deletion when unused, and assignment to products;
...
- real manager workflows M02-M05 against isolated PostgreSQL: `4 passed` on 2026-07-24;
